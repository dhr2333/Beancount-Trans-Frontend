...
const options = [
  ...
  {
    value: '储蓄卡/信用卡忽略支付宝微信条目',
    label: '储蓄卡/信用卡忽略支付宝微信条目',
  },
  {
    value: '文件若加密请选择',
    label: '文件若加密请选择',
...
watch(value4, (newValue) => {
  ...
  if (newValue.includes('储蓄卡/信用卡忽略支付宝微信条目')) {
    CardIgnore.value = true;
  } else {
    CardIgnore.value = false;
  };
